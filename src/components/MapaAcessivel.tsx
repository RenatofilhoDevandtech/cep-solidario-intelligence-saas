  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-7 border border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.03)]">
        ...
        {/* Filter chips - Apple Pill Style for all disabilities */}
        <div className="mt-3 pt-3 border-t border-slate-100 flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={() => setFilterRampa(!filterRampa)}
          ...
          <button
            onClick={() => setFilterElevador(!filterElevador)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterElevador
                ? 'bg-emerald-600 text-white border-emerald-600 shadow-xs'
                : 'bg-slate-100/70 text-slate-700 border-slate-200/80 hover:bg-slate-200/70'
          ...
          <button
            onClick={() => setFilterBanheiro(!filterBanheiro)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterBanheiro
                ? 'bg-emerald-600 text-white border-emerald-600 shadow-xs'
                : 'bg-slate-100/70 text-slate-700 border-slate-200/80 hover:bg-slate-200/70'
          ...
          <button
            onClick={() => setFilterVaga(!filterVaga)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterVaga
                ? 'bg-emerald-600 text-white border-emerald-600 shadow-xs'
                : 'bg-slate-100/70 text-slate-700 border-slate-200/80 hover:bg-slate-200/70'
          ...
          <button
            onClick={() => setFilterPisoTatil(!filterPisoTatil)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterPisoTatil
          ...
          <button
            onClick={() => setFilterLibras(!filterLibras)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterLibras
                ? 'bg-indigo-600 text-white border-indigo-600 shadow-xs'
                : 'bg-indigo-50/70 text-indigo-700 border-indigo-200/80 hover:bg-indigo-100/70'
          ...
          <button
            onClick={() => setFilterSonoro(!filterSonoro)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterSonoro
                ? 'bg-indigo-600 text-white border-indigo-600 shadow-xs'
                : 'bg-indigo-50/70 text-indigo-700 border-indigo-200/80 hover:bg-indigo-100/70'
          ...
          <button
            onClick={() => setFilterEspacoCalmo(!filterEspacoCalmo)}
            className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all cursor-pointer active:scale-95 ${
              filterEspacoCalmo
                ? 'bg-indigo-600 text-white border-indigo-600 shadow-xs'
                : 'bg-indigo-50/70 text-indigo-700 border-indigo-200/80 hover:bg-indigo-100/70'
          ...
          <span className="ml-auto text-xs font-semibold text-slate-500">
            Exibindo: <strong className="text-slate-900">{filteredLocais.length}</strong> {filteredLocais.length === 1 ? 'local' : 'locais'}
